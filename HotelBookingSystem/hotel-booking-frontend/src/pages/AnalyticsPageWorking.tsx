...
const AnalyticsPageWorking: React.FC = () => {
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Price Factors</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {predictions.map((prediction, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell align="right">
                        <Chip 
                          label={`${(prediction.confidenceLevel * 100).toFixed(0)}%`}
                          color={prediction.confidenceLevel > 0.7 ? "success" : prediction.confidenceLevel > 0.5 ? "warning" : "error"}
                          size="small"
                        />
                      </TableCell>
                      <TableCell align="right">{prediction.modelVersion}</TableCell>
                      <TableCell>
                        <Stack direction="row" spacing={1} flexWrap="wrap">
                          {prediction.priceFactors.slice(0, 3).map((factor, factorIndex) => (
                            <Chip 
                              key={factorIndex}
...
export default AnalyticsPageWorking;
